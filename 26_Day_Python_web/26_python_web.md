...
```sh
Izo@guru:~/Desktop$ mkdir python_for_web
Izo@guru:~/Desktop$ cd python_for_web/
Izo@guru:~/Desktop/python_for_web$ virtualenv venv
Izo@guru:~/Desktop/python_for_web$ source venv/bin/activate
(env) Izo@guru:~/Desktop/python_for_web$ pip freeze
(env) Izo@guru:~/Desktop/python_for_web$ pip install Flask
(env) Izo@guru:~/Desktop/python_for_web$ pip freeze
Click==7.0
Flask==1.1.1
itsdangerous==1.1.0
...
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) Izo@guru:~/Desktop/python_for_web$
```
...
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) Izo@guru:~/Desktop/python_for_web$ touch requirements.txt
(env) Izo@guru:~/Desktop/python_for_web$ pip freeze > requirements.txt
(env) Izo@guru:~/Desktop/python_for_web$ cat requirements.txt
Click==7.0
Flask==1.1.1
itsdangerous==1.1.0
Jinja2==2.10.3
