...
<sub>Author:
Javashrimp
<small> Second Edition: March, 2023</small>
</sub>
</div>
...
![Assignment Operators](https://github.com/Asabeneh/30-Days-Of-Python/blob/master/images/assignment_operators.png)
...
![Arithmetic Operators](https://github.com/Asabeneh/30-Days-Of-Python/blob/master/images/arithmetic_operators.png)
...
print('A in Javashrimp', 'A' in 'Javashrimp') # True - A found in the string
print('B in Javashrimp', 'B' in 'Javashrimp') # False - there is no uppercase B
