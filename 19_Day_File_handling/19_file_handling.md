...
person_json = "{'name': 'Izo', 'country': 'Uk', 'city': 'London', 'skills': ['JavaScrip', 'React', 'Python']}"
...
# output
<class 'dict'>
{'name': 'Izo', 'country': 'Uk', 'city': 'London', 'skills': ['JavaScrip', 'React', 'Python']}
Izo
```
...
Column names are :name, country, city, skills
        Izo is a techie. He lives in Uk, London.
Number of lines:  2
```
