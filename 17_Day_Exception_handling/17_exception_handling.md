...
dct = {'name':'Izo', 'country':'UK', 'city':'London', 'age':35}
print(unpacking_person_info(**dct)) # Izo lives in UK, London. He is 35 years old.
```
...
print(packing_person_info(name="Izo",
      country="UK", city="London", age=35))
```
...
city = London
age = 35
{'name': 'Izo', 'country': 'UK', 'city': 'London', 'age': 35}
```
