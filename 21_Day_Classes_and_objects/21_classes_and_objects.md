...
```sh
# output
Izo K is 25 years old. He lives in Helsinki, Uk
```
...
```py
class Person:
      def __init__(self, firstname='Izo', lastname='K', age=25, country='Uk', city='London'):
          self.firstname = firstname
          self.lastname = lastname
          self.age = age
          self.country = country
...
```sh
# output
Izo K is 25 years old. He lives in London, Uk.
John Doe is 30 years old. He lives in Noman city, Nomanland.
['HTML', 'CSS', 'JavaScript']
[]
```
...
```py
class Student(Person):
    def __init__ (self, firstname='Izo', lastname='K',age=25, country='Uk', city='London', gender='male'):
        self.gender = gender
